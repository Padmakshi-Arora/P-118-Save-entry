...
def save():
    ...
    file_handler = open('C:/Users/HP/Downloads/PRO-C118-Project-Boilerplate-main (1)/PRO-C118-Project-Boilerplate-main/static/assets/datafiles/updated_product_dataset.csv','a')
